...
waters.new <- read_xlsx(here("data/2021_waters_collection_Turkana_IsoWater.xlsx")) |>
  mutate(WaterType = str_replace(WaterType, "Ground", "Shallow Ground"))
# col_types = c("text", "date", rep("text", 3), rep("numeric", 2))
