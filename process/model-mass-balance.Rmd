...
pacman::p_load(here, knitr, tidyverse, readxl, lubridate, ggthemes)
```
...
This data set includes measurements from the Ethiopian plateau, and other points outside of Turkana. Filter to Turkana data only using coordiantes, if necessary. 
...
Identify measured values that affect model inputs.
